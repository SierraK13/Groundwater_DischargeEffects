...
```{r, fig.width = 6,fig.height=7, fig.cap= "Groundwater depth for water years 1992 through 2022 at a ground water site near Mammoth Lakes."}
...
ggplotly(gw_depth %>%
  ggplot(aes(x = Date, y = water_depth)) + 
  geom_line(color = 'slateblue2'))
...
time frame. The temperature has a consitent pattern with no major spikes in 
...
precipitation shows and rise and when there is an increase in temperature there
